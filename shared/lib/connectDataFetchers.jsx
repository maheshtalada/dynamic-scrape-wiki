...
export default function connectDataFetchers(Component, actionCreators=[], firstLoad=false, customProps={}) {
	return class DataFetchersWrapper extends Component {
		...
		static fetchData({ dispatch, params = {}, query = {}, locale }) {
			return Promise.all(
				actionCreators.map(actionCreator => dispatch(actionCreator({ params, query, locale,...customProps })))
			);
		}
