...
export default class Autocomplete extends React.Component {
	...
	maybeScrollItemIntoView() {
		if (this.isOpen() && this.state.highlightedIndex !== null) {
			...
			itemNode && menuNode && scrollIntoView(
	...
	renderMenu() {
		...
		return menu && React.cloneElement(menu, {
	...
	render() {
		...
		return (
			<div className={Cx("autocomplete-widget",className)} style={{ ...this.props.wrapperStyle }} {...this.props.wrapperProps}>
				<input
					{...inputProps}
					role="combobox"
