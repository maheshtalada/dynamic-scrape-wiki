exports.config = {
   ...
   /* host: '127.0.0.1',
    ...
    cucumberOpts: {
        ...
        require: [
            './tests/acceptance/steps/given.js',
            './tests/acceptance/steps/then.js',
            './tests/acceptance/steps/when.js',
        ],
    ...
    // define custom commands.
     before: function before() {
         ...
         const getLocator = require('../locators/getLocator');
		 global.expect = chai.expect;
         global.assert = chai.assert;
		 global.should = chai.should();
		 global.locator = getLocator;
     },
    //
